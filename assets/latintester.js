var latinTester = (function() {
    ...
    //Defines variables that point to HTML elements
    function setupElements() {
        startTestButton = document.getElementById("start_button");
        testOptionsContainer = document.getElementById("test_options_container");
        aosSelect = document.getElementById("aosSelect");
        tiersSelect = document.getElementById("tiersSelect");
        testContainer = document.getElementById("test_container");
        testWord = document.getElementById("test_word");
        translationInput = document.getElementById("translation_input");
        submitButton = document.getElementById("submit_button");
        continueButton = document.getElementById("continue_button");
        correctStatusText = document.getElementById("correct_status");
    }
    ...
    return {
        ...
        startTest: function() {
            ...
            xhr.open("GET", "http://mrlaurence.github.io/ocrlatintester/assets/vocabulary_data.txt", true);
            xhr.send();
        },
